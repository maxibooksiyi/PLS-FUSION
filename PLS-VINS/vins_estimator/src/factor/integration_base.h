...
class IntegrationBase
{
  public:
                            ...
                            Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        // //添加的打印部分，打印出bias      
        // ofstream foutC("/home/zj/output/1.txt", ios::app);
        // foutC.setf(ios::fixed, ios::floatfield);
        // foutC.precision(9);
        // foutC << result_linearized_ba(0,0) << " "
        //       <<result_linearized_ba(1,0) << " "
        //       <<result_linearized_ba(2,0) << " "
        //       << result_linearized_bg(0,0) <<" "
        //       << result_linearized_bg(1,0) <<" "
        //       << result_linearized_bg(2,0) <<endl;
        ...
        if(update_jacobian)
        {
            ...
            // 对应VIO课程中第三讲的公式44 这个就是雅克比矩阵啊！！ F矩阵
