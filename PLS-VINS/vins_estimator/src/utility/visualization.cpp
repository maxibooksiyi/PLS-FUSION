...
ros::Publisher pub_point_cloud, pub_margin_cloud,pub_lines, pub_marg_lines;//点特征和线特征
...
void pubOdometry(const Estimator &estimator, const std_msgs::Header &header)
{
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        // ofstream foutC("/home/zj/line_catkin_ws/src/PLS-VINS/Trajactory/tum_fast_no_loop.txt", ios::app);
        ...
        // ofstream foutC1("/home/zj/line_catkin_ws/src/PLS-VINS/Trajactory/evo_fast_no_loop.txt", ios::app);
